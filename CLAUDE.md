# ServiceNow Connector Documentation — Claude Code Project

This repository contains the ServiceNow Connector product documentation site built with Docusaurus.
...
└── resources/
    ...
    └── opcon-primary-analysis.md          # 11-section template for page completeness scoring
```
